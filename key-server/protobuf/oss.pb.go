...
type StoreRequest struct {
	...
	EncMessage []byte `protobuf:"bytes,1,opt,name=enc_message,json=encMessage,proto3" json:"enc_message,omitempty"`
}
...
func (x *StoreRequest) GetEncMessage() []byte {
	if x != nil {
		return x.EncMessage
	}
	return nil
...
func (x *RecieveResponse) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_oss_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x65, 0x6e, 0x63, 0x4d,
	...
	0x6b, 0x65, 0x79, 0x32, 0xd9, 0x02, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x12,
